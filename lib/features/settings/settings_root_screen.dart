...
class SettingsRootScreen extends StatelessWidget {
  ...
  List<SettingsSearchResult> _searchIndex() => <SettingsSearchResult>[
        SettingsSearchResult(
          title: 'Advanced settings',
          category: 'Settings',
          description: 'Privacy, messaging, status, media, appearance, navigation and behavior controls',
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (user.about.isNotEmpty)
                          Text(user.about, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: theme.secondaryTextColor, fontSize: 11.5)),
                      ],
                    ),
                  ),
                ],
            ...
            _SectionTitle(theme: theme, label: 'Settings controls'),
            _SettingsTile(
              theme: theme,
              icon: Icons.tune_rounded,
              title: 'Advanced settings',
              subtitle: 'Organized privacy, chats, appearance, status, calls, media, navigation and behavior settings',
              onTap: () => _push(context, GbSettingsHubScreen(preferencesController: preferencesController)),
            ),
            const SizedBox(height: 14),
            _SectionTitle(theme: theme, label: 'Appearance'),
            _SettingsTile(theme: theme, icon: Icons.palette_rounded, title: 'Themes', subtitle: 'Light and dark theme presets', onTap: () => _push(context, ChatyThemeEditorScreen(themeController: themeController))),
            _SettingsTile(theme: theme, icon: Icons.auto_awesome_rounded, title: 'Universal appearance', subtitle: 'Navigation, bars, icons, fonts and motion', onTap: () => _push(context, UniversalAppearanceScreen(preferencesController: preferencesController))),
            _SettingsTile(theme: theme, icon: Icons.home_outlined, title: 'Home screen', subtitle: 'Search, stories and home layout', onTap: () => _push(context, HomeScreenSettingsPage(preferencesController: preferencesController))),
            _SettingsTile(theme: theme, icon: Icons.chat_bubble_outline_rounded, title: 'Conversation', subtitle: 'Bubbles, wallpaper and chat layout', onTap: () => _push(context, ConversationSettingsPage(preferencesController: preferencesController))),
            const SizedBox(height: 14),
            _SectionTitle(theme: theme, label: 'Privacy & security'),
            _SettingsTile(theme: theme, icon: Icons.visibility_off_rounded, title: 'Privacy', subtitle: 'Last seen, receipts and anti-delete options', onTap: () => _push(context, PrivacyCenterScreen(preferencesController: preferencesController))),
            _SettingsTile(theme: theme, icon: Icons.security_rounded, title: 'Security', subtitle: 'App lock and account protection', onTap: () => _push(context, SecurityCenterScreen(preferencesController: preferencesController))),
            const SizedBox(height: 14),
            ...
            _SettingsTile(
              ...
              onTap: () => _push(context, NotificationSettingsPage(preferencesController: preferencesController, notificationService: notificationService)),
            ),
            _SettingsTile(
              theme: theme,
              ...
              onTap: () => _push(context, MessageManagementPage(preferencesController: preferencesController, dataStore: dataStore)),
            ),
            _SettingsTile(theme: theme, icon: Icons.animation_rounded, title: 'Navigation effects', subtitle: 'Page transitions and interaction effects', onTap: () => _push(context, NavigationEffectsPage(preferencesController: preferencesController))),
            _SettingsTile(
              theme: theme,
              icon: Icons.admin_panel_settings_outlined,
              title: 'Permissions',
              subtitle: 'Camera, microphone, media, contacts and notifications',
              onTap: () => _push(context, SystemPermissionsScreen(preferencesController: preferencesController, notificationService: notificationService)),
            ),
          ],
        ),
      ),
...
class _SectionTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Text(label.toUpperCase(), style: TextStyle(color: theme.secondaryTextColor, fontSize: 10.5, fontWeight: FontWeight.w800, letterSpacing: 0.8)),
      );
}
