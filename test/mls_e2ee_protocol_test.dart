...
void main() {
  ...
  test('OpenMLS encrypts application payload across two independent devices', () async {
    await Openmls.init();
    ...
    try {
      ...
      expect(utf8.decode(encrypted.ciphertext, allowMalformed: true),
      ...
      expect(replyDecrypted.applicationMessage, orderedEquals(replyCleartext));
    } finally {
      await alice.close();
      await bob.close();
    }
