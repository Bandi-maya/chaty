-- Resolve a username to its registered email only when the supplied password
-- already validates against the associated Supabase Auth account. This keeps
-- username login compatible with Supabase email/password auth without exposing
